...
document.getElementById("inputButton1").addEventListener('click',function(){
    processSearch1(document.getElementById('input1').value);
});

document.getElementById("inputButton2").addEventListener('click',function(){
    processSearch2(document.getElementById('input2').value);
});
...
function processSearch1(searchType){
...
function processSearch2(searchPrice){
...
function updateTable(tableId, productArray){
    ...
    for(i=0;i<productArray.length;i++){
        ...
        td4.addEventListener('click',function(){ processSearch(this.parentNode.firstChild.innerHTML);       });
